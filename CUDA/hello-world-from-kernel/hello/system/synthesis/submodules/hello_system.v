...
(
   ...
   input logic resetn,
   // AVS avs_hello_cra
   input logic avs_hello_cra_enable,
   input logic avs_hello_cra_read,
   input logic avs_hello_cra_write,
   input logic [3:0] avs_hello_cra_address,
   input logic [63:0] avs_hello_cra_writedata,
   input logic [7:0] avs_hello_cra_byteenable,
   output logic [63:0] avs_hello_cra_readdata,
   output logic avs_hello_cra_readdatavalid,
   ...
   logic [29:0] gmem0_global_avm_address [1];
   ...
   // INST hello_std_ic_inst of hello_std_ic_partition_wrapper
   hello_std_ic_partition_wrapper hello_std_ic_inst
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq_hello(kernel_irqs),
      // AVS avs_hello_cra
      .avs_hello_cra_enable(avs_hello_cra_enable),
      .avs_hello_cra_read(avs_hello_cra_read),
      .avs_hello_cra_write(avs_hello_cra_write),
      .avs_hello_cra_address(avs_hello_cra_address),
      .avs_hello_cra_writedata(avs_hello_cra_writedata),
      .avs_hello_cra_byteenable(avs_hello_cra_byteenable),
      .avs_hello_cra_readdata(avs_hello_cra_readdata),
      .avs_hello_cra_readdatavalid(avs_hello_cra_readdatavalid),
      // AVM hello_0_avm_memdep
      .hello_0_avm_memdep_enable(gmem0_global_avm_enable[0]),
      .hello_0_avm_memdep_read(gmem0_global_avm_read[0]),
      .hello_0_avm_memdep_write(gmem0_global_avm_write[0]),
      .hello_0_avm_memdep_burstcount(gmem0_global_avm_burstcount[0]),
      .hello_0_avm_memdep_address(gmem0_global_avm_address[0]),
      .hello_0_avm_memdep_writedata(gmem0_global_avm_writedata[0]),
      .hello_0_avm_memdep_byteenable(gmem0_global_avm_byteenable[0]),
      .hello_0_avm_memdep_waitrequest(gmem0_global_avm_waitrequest[0]),
      .hello_0_avm_memdep_readdata(gmem0_global_avm_readdata[0]),
      .hello_0_avm_memdep_readdatavalid(gmem0_global_avm_readdatavalid[0]),
      .hello_0_avm_memdep_writeack(gmem0_global_avm_writeack[0])
   );
...
/////////////////////////////////////////////////////////////////
// MODULE hello_std_ic_partition_wrapper
/////////////////////////////////////////////////////////////////
module hello_std_ic_partition_wrapper
(
   input logic clock,
   ...
   output logic avs_hello_cra_readdatavalid,
   // AVM hello_0_avm_memdep
   output logic hello_0_avm_memdep_enable,
   output logic hello_0_avm_memdep_read,
   output logic hello_0_avm_memdep_write,
   output logic [4:0] hello_0_avm_memdep_burstcount,
   output logic [29:0] hello_0_avm_memdep_address,
   output logic [255:0] hello_0_avm_memdep_writedata,
   output logic [31:0] hello_0_avm_memdep_byteenable,
   input logic hello_0_avm_memdep_waitrequest,
   input logic [255:0] hello_0_avm_memdep_readdata,
   input logic hello_0_avm_memdep_readdatavalid,
   input logic hello_0_avm_memdep_writeack
);
   logic hello_start;
   logic [0:0] hello_start_chain;
   logic [0:0] hello_start_kernel_copy;
   logic [0:0] hello_start_task_fd;
   logic [0:0] hello_start_finish_element;
   logic hello_finish;
   logic [0:0] hello_finish_kernel_copy;
   logic [0:0] hello_finish_chain;
   logic [31:0] hello_global_size [2:0];
   logic [31:0] hello_num_groups [2:0];
   logic [31:0] hello_local_size [2:0];
   logic [31:0] hello_global_offset [2:0];
   logic [31:0] hello_work_dim;
   logic [31:0] hello_wg_size;
   logic [0:0] hello_wg_disp_stall_in;
   logic [0:0] hello_wg_disp_stall_in_lookahead;
   logic [0:0] hello_wg_disp_valid_out;
   logic hello_wg_disp_start_out;
   logic [31:0] hello_wg_disp_group_id_out [2:0];
   logic [31:0] hello_wg_disp_global_id_base_out [2:0];
   logic hello_wg_disp_dispatched_all_groups;
   logic [31:0] hello_global_id [1][2:0];
   logic [31:0] hello_local_id [1][2:0];
   logic [31:0] hello_group_id [1][2:0];
   logic [0:0] hello_pending_write;
   logic [0:0] hello_lsu_active;
   logic [0:0] hello_valid_in;
   logic [0:0] hello_valid_out;
   logic [0:0] hello_stall_in;
   logic [0:0] hello_stall_out;
   logic hello_cra_pending_write;
   logic hello_cra_lsu_active;
   logic hello_cra_valid_in;
   logic [63:0] hello_kernel_arguments;

   assign hello_start_chain[0] = hello_start;
   assign hello_finish_chain[0] = 1'b1;
   assign hello_cra_pending_write = |hello_pending_write;
   assign hello_cra_lsu_active = |hello_lsu_active;
   assign hello_cra_valid_in = |hello_valid_in;
   assign hello_stall_in = 0;
   // INST hello_workgroup_dispatcher of acl_work_group_dispatcher
   ...
   hello_workgroup_dispatcher
   (
      .clock(clock),
      .resetn(resetn),
      .start(hello_start),
      .num_groups(hello_num_groups),
      .local_size(hello_local_size),
      .stall_in(hello_wg_disp_stall_in),
      .stall_in_lookahead(hello_wg_disp_stall_in_lookahead),
      .valid_out(hello_wg_disp_valid_out),
      .group_id_out(hello_wg_disp_group_id_out),
      .global_id_base_out(hello_wg_disp_global_id_base_out),
      .start_out(hello_wg_disp_start_out),
      .dispatched_all_groups(hello_wg_disp_dispatched_all_groups)
   );

   // INST hello_finish_detector of acl_kernel_finish_detector
   ...
   hello_finish_detector
   (
      .clock(clock),
      .resetn(resetn),
      .start(hello_start),
      .wg_size(hello_wg_size),
      .wg_dispatch_valid_out(hello_wg_disp_valid_out),
      .wg_dispatch_stall_in(hello_wg_disp_stall_in),
      .dispatched_all_groups(hello_wg_disp_dispatched_all_groups),
      .kernel_copy_valid_out(hello_valid_out),
      .kernel_copy_stall_in(hello_stall_in),
      .pending_writes(hello_cra_pending_write),
      .finish(hello_finish)
   );

   // INST hello_cra_slave_inst of hello_function_cra_slave
   hello_function_cra_slave hello_cra_slave_inst
   (
      .clock(clock),
      .resetn(resetn),
      .start(hello_start),
      .finish(hello_finish),
      .global_offset_0(hello_global_offset[0]),
      .global_offset_1(hello_global_offset[1]),
      .global_offset_2(hello_global_offset[2]),
      .work_dim(hello_work_dim),
      .has_a_lsu_active(hello_cra_lsu_active),
      .has_a_write_pending(hello_cra_pending_write),
      .valid_in(hello_cra_valid_in),
      .global_size_0(hello_global_size[0]),
      .global_size_1(hello_global_size[1]),
      .global_size_2(hello_global_size[2]),
      .num_groups_0(hello_num_groups[0]),
      .num_groups_1(hello_num_groups[1]),
      .num_groups_2(hello_num_groups[2]),
      .local_size_0(hello_local_size[0]),
      .local_size_1(hello_local_size[1]),
      .local_size_2(hello_local_size[2]),
      .workgroup_size(hello_wg_size),
      .kernel_arguments(hello_kernel_arguments),
      .cra_irq(cra_irq_hello),
      // AVS avs_cra
      .avs_cra_enable(avs_hello_cra_enable),
      .avs_cra_read(avs_hello_cra_read),
      .avs_cra_write(avs_hello_cra_write),
      .avs_cra_address(avs_hello_cra_address),
      .avs_cra_writedata(avs_hello_cra_writedata),
      .avs_cra_byteenable(avs_hello_cra_byteenable),
      .avs_cra_readdata(avs_hello_cra_readdata),
      .avs_cra_readdatavalid(avs_hello_cra_readdatavalid)
   );

   // INST hello_id_iter_inst_0 of acl_id_iterator
   acl_id_iterator
   #(
      .WIDTH(32),
      .LOCAL_WIDTH_X(32),
   ...
   hello_id_iter_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start(hello_wg_disp_start_out),
      .valid_in(hello_wg_disp_valid_out[0]),
      .stall_out(hello_wg_disp_stall_in[0]),
      .stall_out_lookahead(hello_wg_disp_stall_in_lookahead[0]),
      .stall_in(hello_stall_out[0]),
      .valid_out(hello_valid_in[0]),
      .group_id_in(hello_wg_disp_group_id_out),
      .global_id_base_in(hello_wg_disp_global_id_base_out),
      .local_size(hello_local_size),
      .global_size(hello_global_size),
      .local_id(hello_local_id[0]),
      .global_id(hello_global_id[0]),
      .group_id(hello_group_id[0])
   );

   // INST hello_inst_0 of hello_top_wrapper_0
   hello_top_wrapper_0 hello_inst_0
   (
      .start(hello_start_kernel_copy[0]),
      .kernel_arguments(hello_kernel_arguments),
      .work_dim(hello_work_dim),
      .global_offset(hello_global_offset),
      .kernel_valid_out(hello_valid_out[0]),
      .has_a_write_pending(hello_pending_write[0]),
      .has_a_lsu_active(hello_lsu_active[0]),
      .global_id(hello_global_id[0]),
      .local_id(hello_local_id[0]),
      .group_id(hello_group_id[0]),
      .global_size(hello_global_size),
      ...
      .num_groups(hello_num_groups),
      .workgroup_size(hello_wg_size),
      .kernel_stall_out(hello_stall_out[0]),
      .kernel_valid_in(hello_valid_in[0]),
      .clock(clock),
      .resetn(resetn),
      .clock2x(clock2x),
      // AVM avm_memdep
      .avm_memdep_enable(hello_0_avm_memdep_enable),
      .avm_memdep_read(hello_0_avm_memdep_read),
      .avm_memdep_write(hello_0_avm_memdep_write),
      .avm_memdep_burstcount(hello_0_avm_memdep_burstcount),
      .avm_memdep_address(hello_0_avm_memdep_address),
      .avm_memdep_writedata(hello_0_avm_memdep_writedata),
      .avm_memdep_byteenable(hello_0_avm_memdep_byteenable),
      .avm_memdep_waitrequest(hello_0_avm_memdep_waitrequest),
      .avm_memdep_readdata(hello_0_avm_memdep_readdata),
      .avm_memdep_readdatavalid(hello_0_avm_memdep_readdatavalid),
      .avm_memdep_writeack(hello_0_avm_memdep_writeack)
   );

   // INST hello_start_elem_inst_0 of acl_start_signal_chain_element
   acl_start_signal_chain_element
   #(
      .ASYNC_RESET(1),
      .SYNCHRONIZE_RESET(0)
   )
   hello_start_elem_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start_in(hello_start_chain[0]),
      .start_kernel(hello_start_kernel_copy[0]),
      .start_finish_detector(hello_start_task_fd[0]),
      .start_finish_chain_element(hello_start_finish_element[0]),
      .start_chain()
   );
...
(
   ...
   input logic clock2x,
   // AVM avm_memdep
   output logic avm_memdep_enable,
   output logic avm_memdep_read,
   output logic avm_memdep_write,
   output logic [4:0] avm_memdep_burstcount,
   output logic [29:0] avm_memdep_address,
   output logic [255:0] avm_memdep_writedata,
   output logic [31:0] avm_memdep_byteenable,
   input logic avm_memdep_waitrequest,
   input logic [255:0] avm_memdep_readdata,
   input logic avm_memdep_readdatavalid,
   input logic avm_memdep_writeack
);
   logic lmem_invalid_single_bit;

   // INST kernel of hello_function_wrapper
   hello_function_wrapper kernel
   (
      ...
      .clock2x(clock2x),
      // AVM avm_memdep
      .avm_memdep_enable(avm_memdep_enable),
      .avm_memdep_read(avm_memdep_read),
      .avm_memdep_write(avm_memdep_write),
      .avm_memdep_burstcount(avm_memdep_burstcount),
      .avm_memdep_address(avm_memdep_address),
      .avm_memdep_writedata(avm_memdep_writedata),
      .avm_memdep_byteenable(avm_memdep_byteenable),
      .avm_memdep_waitrequest(avm_memdep_waitrequest),
      .avm_memdep_readdata(avm_memdep_readdata),
      .avm_memdep_readdatavalid(avm_memdep_readdatavalid),
      .avm_memdep_writeack(avm_memdep_writeack)
   );
...
(
   ...
   input logic [29:0] gmem0_mtree_avm_address [1],
   ...
   begin:gmem0_
      ...
      logic [24:0] gmem0_icm_in_arb_address [1];
      ...
      logic [24:0] gmem0_icm_preroute_arb_address [1];
      ...
      // INST global_ic_preroutegmem0_router_0 of hello_system_interconnect_0
      hello_system_interconnect_0 global_ic_preroutegmem0_router_0
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_icgmem0_port_0_0_rw of hello_system_interconnect_1
      hello_system_interconnect_1 global_icgmem0_port_0_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE hello_system_interconnect_0
/////////////////////////////////////////////////////////////////
module hello_system_interconnect_0
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE hello_system_interconnect_1
/////////////////////////////////////////////////////////////////
module hello_system_interconnect_1
(
   input logic clock,
