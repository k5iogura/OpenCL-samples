...
module system_acl_iface_mm_interconnect_2 (
	...
	wire  [86:0] version_id_s_agent_rf_source_data;                                          // version_id_s_agent:rf_source_data -> version_id_s_agent_rsp_fifo:in_data
	...
	wire  [86:0] version_id_s_agent_rsp_fifo_out_data;                                       // version_id_s_agent_rsp_fifo:out_data -> version_id_s_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> version_id_s_agent:cp_data
	wire         cmd_mux_src_ready;                                                          // version_id_s_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> version_id_s_agent:cp_channel
	...
	wire  [86:0] acl_kernel_interface_ctrl_agent_rf_source_data;                             // acl_kernel_interface_ctrl_agent:rf_source_data -> acl_kernel_interface_ctrl_agent_rsp_fifo:in_data
	...
	wire  [86:0] acl_kernel_interface_ctrl_agent_rsp_fifo_out_data;                          // acl_kernel_interface_ctrl_agent_rsp_fifo:out_data -> acl_kernel_interface_ctrl_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> acl_kernel_interface_ctrl_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // acl_kernel_interface_ctrl_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> acl_kernel_interface_ctrl_agent:cp_channel
	...
	wire  [85:0] pipe_stage_host_ctrl_m0_agent_cp_data;                                      // pipe_stage_host_ctrl_m0_agent:cp_data -> router:sink_data
	...
	wire  [85:0] version_id_s_agent_rp_data;                                                 // version_id_s_agent:rp_data -> router_001:sink_data
	...
	wire  [85:0] acl_kernel_interface_ctrl_agent_rp_data;                                    // acl_kernel_interface_ctrl_agent:rp_data -> router_002:sink_data
	...
	wire  [85:0] router_src_data;                                                            // router:src_data -> pipe_stage_host_ctrl_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                           // pipe_stage_host_ctrl_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [1:0] router_src_channel;                                                         // router:src_channel -> pipe_stage_host_ctrl_m0_limiter:cmd_sink_channel
	...
	wire  [85:0] pipe_stage_host_ctrl_m0_limiter_cmd_src_data;                               // pipe_stage_host_ctrl_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         pipe_stage_host_ctrl_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> pipe_stage_host_ctrl_m0_limiter:cmd_src_ready
	wire   [1:0] pipe_stage_host_ctrl_m0_limiter_cmd_src_channel;                            // pipe_stage_host_ctrl_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [85:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> pipe_stage_host_ctrl_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                          // pipe_stage_host_ctrl_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> pipe_stage_host_ctrl_m0_limiter:rsp_sink_channel
	...
	wire  [85:0] pipe_stage_host_ctrl_m0_limiter_rsp_src_data;                               // pipe_stage_host_ctrl_m0_limiter:rsp_src_data -> pipe_stage_host_ctrl_m0_agent:rp_data
	...
	wire   [1:0] pipe_stage_host_ctrl_m0_limiter_rsp_src_channel;                            // pipe_stage_host_ctrl_m0_limiter:rsp_src_channel -> pipe_stage_host_ctrl_m0_agent:rp_channel
	...
	wire   [1:0] pipe_stage_host_ctrl_m0_limiter_cmd_valid_data;                             // pipe_stage_host_ctrl_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	system_acl_iface_mm_interconnect_2_rsp_demux rsp_demux_001 (
		.clk                (config_clk_out_clk_clk),                                 //       clk.clk
		.reset              (pipe_stage_host_ctrl_reset_reset_bridge_in_reset_reset), // clk_reset.reset
