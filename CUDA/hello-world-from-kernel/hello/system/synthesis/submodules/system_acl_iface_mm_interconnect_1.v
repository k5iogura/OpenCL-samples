...
module system_acl_iface_mm_interconnect_1 (
	...
	system_acl_iface_mm_interconnect_1_router router (
	...
	system_acl_iface_mm_interconnect_1_router_001 router_001 (
	...
	system_acl_iface_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_outclk0_clk),                                                //       clk.clk
		.reset              (address_span_extender_kernel_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_acl_iface_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_outclk0_clk),                                                  //       clk.clk
		.reset               (hps_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_acl_iface_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (pll_outclk0_clk),                                                  //       clk.clk
		.reset              (hps_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_acl_iface_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_outclk0_clk),                                                //       clk.clk
		.reset               (address_span_extender_kernel_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_acl_iface_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
