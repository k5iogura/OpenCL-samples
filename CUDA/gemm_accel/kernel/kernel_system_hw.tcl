...
set_module_property DISPLAY_NAME kernel_system
...
#### Slave interface avs_global_id_cra
add_interface avs_global_id_cra avalon end
set_interface_property avs_global_id_cra ENABLED true
set_interface_property avs_global_id_cra associatedClock clock_reset
set_interface_property avs_global_id_cra addressAlignment DYNAMIC
set_interface_property avs_global_id_cra burstOnBurstBoundariesOnly false
set_interface_property avs_global_id_cra explicitAddressSpan 0
set_interface_property avs_global_id_cra holdTime 0
set_interface_property avs_global_id_cra isMemoryDevice false
set_interface_property avs_global_id_cra isNonVolatileStorage false
set_interface_property avs_global_id_cra linewrapBursts false
set_interface_property avs_global_id_cra maximumPendingReadTransactions 1
set_interface_property avs_global_id_cra printableDevice false
set_interface_property avs_global_id_cra readLatency 0
set_interface_property avs_global_id_cra readWaitTime 0
set_interface_property avs_global_id_cra setupTime 0
set_interface_property avs_global_id_cra timingUnits Cycles
set_interface_property avs_global_id_cra writeWaitTime 0
set_interface_assignment avs_global_id_cra hls.cosim.name {}
add_interface_port avs_global_id_cra avs_global_id_cra_read read input 1
add_interface_port avs_global_id_cra avs_global_id_cra_write write input 1
add_interface_port avs_global_id_cra avs_global_id_cra_address address input 4
add_interface_port avs_global_id_cra avs_global_id_cra_writedata writedata input 64
add_interface_port avs_global_id_cra avs_global_id_cra_byteenable byteenable input 8
add_interface_port avs_global_id_cra avs_global_id_cra_readdata readdata output 64
add_interface_port avs_global_id_cra avs_global_id_cra_readdatavalid readdatavalid output 1
...
#### Master interface avm_mem_gmem0_port_1_0_rw with base address 1073741824
add_interface avm_mem_gmem0_port_1_0_rw avalon start
set_interface_property avm_mem_gmem0_port_1_0_rw ENABLED true
set_interface_property avm_mem_gmem0_port_1_0_rw associatedClock clock_reset
set_interface_property avm_mem_gmem0_port_1_0_rw burstOnBurstBoundariesOnly false
set_interface_property avm_mem_gmem0_port_1_0_rw doStreamReads false
set_interface_property avm_mem_gmem0_port_1_0_rw doStreamWrites false
set_interface_property avm_mem_gmem0_port_1_0_rw linewrapBursts false
set_interface_property avm_mem_gmem0_port_1_0_rw readWaitTime 0
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_address address output 30
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_byteenable byteenable output 32
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_readdatavalid readdatavalid input 1
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_read read output 1
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_readdata readdata input 256
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_write write output 1
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_writedata writedata output 256
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_waitrequest waitrequest input 1
add_interface_port avm_mem_gmem0_port_1_0_rw avm_mem_gmem0_port_1_0_rw_burstcount burstcount output 5

add_fileset QUARTUS_SYNTH QUARTUS_SYNTH "" ""
set_fileset_property QUARTUS_SYNTH TOP_LEVEL kernel_system
...
add_fileset_file global_id_function_wrapper.vhd VHDL PATH kernel_hdl/global_id/global_id_function_wrapper.vhd TOP_LEVEL_FILE
add_fileset_file global_id_function.vhd VHDL PATH kernel_hdl/global_id/global_id_function.vhd TOP_LEVEL_FILE
add_fileset_file bb_global_id_B0.vhd VHDL PATH kernel_hdl/global_id/bb_global_id_B0.vhd TOP_LEVEL_FILE
add_fileset_file bb_global_id_B0_stall_region.vhd VHDL PATH kernel_hdl/global_id/bb_global_id_B0_stall_region.vhd TOP_LEVEL_FILE
add_fileset_file global_id_B0_merge_reg.vhd VHDL PATH kernel_hdl/global_id/global_id_B0_merge_reg.vhd TOP_LEVEL_FILE
add_fileset_file i_store_unnamed_global_id0_global_id3.vhd VHDL PATH kernel_hdl/global_id/i_store_unnamed_global_id0_global_id3.vhd TOP_LEVEL_FILE
add_fileset_file i_printf_printf_addr_global_id0.vhd VHDL PATH kernel_hdl/global_id/i_printf_printf_addr_global_id0.vhd TOP_LEVEL_FILE
add_fileset_file global_id_B0_branch.vhd VHDL PATH kernel_hdl/global_id/global_id_B0_branch.vhd TOP_LEVEL_FILE
add_fileset_file global_id_B0_merge.vhd VHDL PATH kernel_hdl/global_id/global_id_B0_merge.vhd TOP_LEVEL_FILE
add_fileset_file global_id_function_cra_slave.vhd VHDL PATH kernel_hdl/global_id/global_id_function_cra_slave.vhd TOP_LEVEL_FILE
