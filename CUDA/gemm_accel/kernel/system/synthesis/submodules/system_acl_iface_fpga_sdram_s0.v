// system_acl_iface_fpga_sdram_s0.v
...
`timescale 1 ps / 1 ps
module system_acl_iface_fpga_sdram_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (14336),
		.INIT_FILE        ("system_acl_iface_fpga_sdram_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	system_acl_iface_fpga_sdram_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	system_acl_iface_fpga_sdram_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
