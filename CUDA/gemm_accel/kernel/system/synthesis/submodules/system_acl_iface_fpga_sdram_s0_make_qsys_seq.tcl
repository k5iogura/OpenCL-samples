...
lappend arg_list "--component-param=SEQUENCER_VERSION=18.0"
...
lappend arg_list "--component-param=SEQ_ROM=system_acl_iface_fpga_sdram_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=system_acl_iface_fpga_sdram_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=system_acl_iface_fpga_sdram_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=AFI_CLK_PS=2500"
...
lappend arg_list "--output-name=system_acl_iface_fpga_sdram_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:system_acl_iface_fpga_sdram_s0.sopcinfo"
lappend arg_list "--report-file=txt:system_acl_iface_fpga_sdram_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/opt/intelFPGA/18.0/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
