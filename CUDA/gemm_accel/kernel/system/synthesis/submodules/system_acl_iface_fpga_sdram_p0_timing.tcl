...
# Board skews
set board(abs_max_CK_delay) 0.29133
set board(abs_max_DQS_delay) 0.28664
set board(minCK_DQS_skew) -0.00583
set board(maxCK_DQS_skew) 0.048525
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.00178
set board(inter_DQS_group_skew) 0.02961
set board(DQ_DQS_skew) 0.0
set board(intra_addr_ctrl_skew) 0.096665
set board(addresscmd_CK_skew) 0.026244
