...
`timescale 1 ps / 1 ps
module system_acl_iface_fpga_sdram (
		...
		output wire [255:0] avl_rdata_0,                //                   .readdata
		input  wire [255:0] avl_wdata_0,                //                   .writedata
		input  wire [31:0]  avl_be_0,                   //                   .byteenable
	...
	system_acl_iface_fpga_sdram_pll0 pll0 (
	...
	system_acl_iface_fpga_sdram_p0 p0 (
		.global_reset_n             (global_reset_n),                                                                                                                                                                            //        global_reset.reset_n
	...
	system_acl_iface_fpga_sdram_s0 s0 (
		.avl_clk                 (p0_avl_clk_clk),                 //          avl_clk.clk
		.avl_reset_n             (p0_avl_reset_reset),             //        avl_reset.reset_n
		.scc_clk                 (p0_scc_clk_clk),                 //          scc_clk.clk
	...
	altera_mem_if_hard_memory_controller_top_cyclonev #(
		...
		.mp_cmd_clk_2            (mp_cmd_clk_0_clk),                   //       mp_cmd_clk_2.clk
		.mp_cmd_reset_n_2        (mp_cmd_reset_n_0_reset_n),           //   mp_cmd_reset_n_2.reset_n
		.mp_cmd_clk_3            (mp_cmd_clk_0_clk),                   //       mp_cmd_clk_3.clk
		.mp_cmd_reset_n_3        (mp_cmd_reset_n_0_reset_n),           //   mp_cmd_reset_n_3.reset_n
		...
		.avl_size_1              (5'b00000),                           //        (terminated)
		...
		.avl_size_2              (5'b00000),                           //        (terminated)
		...
		.avl_size_3              (5'b00000),                           //        (terminated)
		...
		.avl_size_4              (5'b00000),                           //        (terminated)
		...
		.avl_size_5              (5'b00000),                           //        (terminated)
